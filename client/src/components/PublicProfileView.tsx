...
import {
  MapPin, Globe, Star, MessageCircle,
  Award, Calendar, Activity, Microscope,
} from "lucide-react";
...
// ─── Public profile view (shared by /members/:id page + /profile preview) ───────
export function PublicProfileView({
  ...
  const contributions = [...(rawContributions ?? [])].sort((a, b) => b.createdAt - a.createdAt);
    ...
    <div
      className={
        embedded
          ...
          : "flex flex-col gap-6 px-4 md:px-8 py-8 max-w-2xl mx-auto w-full pb-28 md:pb-16"
      }
    >
      {/* ── Hero card ──────────────────────────────────────────────────── */}
