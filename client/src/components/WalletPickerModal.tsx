...
export function WalletPickerModal({ onClose }: WalletPickerModalProps) {
  ...
  const WALLETS = [
    ...
    },
    {
      id: "walletconnect",
      name: "WalletConnect",
      desc: "Ledger · Trezor · 300+ wallets",
  ...
  const HARDWARE = [
    {
      id: "ledger",
      name: "Ledger",
      desc: "Connect via WalletConnect",
      icon: <LedgerSVG />,
      accent: "#CCCCCC",
    },
    {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-0 sm:p-4">
      ...
      <div
        ...
        className="relative z-10 w-full sm:max-w-md bg-[#060f12] border border-[#83eef018] rounded-t-3xl sm:rounded-3xl shadow-[0_-8px_60px_rgba(0,0,0,0.7),0_0_0_1px_rgba(131,238,240,0.06)] overflow-hidden max-h-[92svh] flex flex-col"
      >
        {/* Header */}
        <div className="flex items-center justify-between px-5 pt-5 pb-3 flex-shrink-0">
          ...
          <button
            ...
            className="w-8 h-8 rounded-full bg-[#ffffff0a] hover:bg-[#ffffff14] flex items-center justify-center transition-colors flex-shrink-0"
          >
        ...
        <div className="overflow-y-auto flex-1 px-4 pb-6">
          ...
          <div className="flex flex-col gap-2 mb-4">
            {WALLETS.map((w) => (
              <button
                ...
                className="flex items-center gap-3 w-full px-4 py-3 rounded-2xl border border-[#ffffff0e] bg-[#ffffff05] hover:bg-[#ffffff0c] active:bg-[#ffffff12] transition-colors text-left group"
                style={{ borderColor: `${w.accent}18` }}
              >
                <div
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="[font-family:'Inter',Helvetica] text-[#d4e9f350] text-xs leading-snug mt-0.5">
                    {w.desc}
                  </div>
                </div>
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" className="text-[#d4e9f330] group-hover:text-[#83eef060] transition-colors flex-shrink-0">
          ...
          <div className="mb-4">
            <div className="flex items-center gap-2 mb-2 px-1">
              ...
              <span className="[font-family:'Inter',Helvetica] text-[#d4e9f330] text-[10px] uppercase tracking-widest">Hardware Wallets</span>
              <div className="h-px flex-1 bg-[#ffffff0a]" />
            </div>
            <div className="grid grid-cols-2 gap-2">
              {HARDWARE.map((w) => (
                <button
                  ...
                  onClick={handleWallet}
                  data-testid={`wallet-option-${w.id}`}
                  className="flex flex-col items-center gap-2 px-3 py-3.5 rounded-2xl border border-[#ffffff0e] bg-[#ffffff05] hover:bg-[#ffffff0c] active:bg-[#ffffff12] transition-colors"
                  style={{ borderColor: `${w.accent}18` }}
                >
                  <div
                    className="w-11 h-11 rounded-xl flex items-center justify-center flex-shrink-0 shadow-sm"
                  ...
                  <div className="text-center">
                    ...
                    <div className="[font-family:'Inter',Helvetica] text-[#d4e9f340] text-[10px] leading-snug mt-0.5">
                      via WalletConnect
                    </div>
                  </div>
                </button>
          ...
          <div className="mb-4">
            <div className="flex items-center gap-2 mb-2 px-1">
              <div className="h-px flex-1 bg-[#ffffff0a]" />
              <span className="[font-family:'Inter',Helvetica] text-[#d4e9f330] text-[10px] uppercase tracking-widest">Research Identity</span>
              <div className="h-px flex-1 bg-[#ffffff0a]" />
            </div>
            <button
              onClick={handleOrcid}
              data-testid="wallet-option-orcid"
              className="flex items-center gap-3 w-full px-4 py-3 rounded-2xl border border-[#A6CE3920] bg-[#A6CE3908] hover:bg-[#A6CE3914] active:bg-[#A6CE3920] transition-colors text-left group"
            >
              <div className="w-11 h-11 rounded-xl bg-[#A6CE3918] flex items-center justify-center flex-shrink-0 shadow-sm">
                <OrcidIcon size={28} />
              </div>
              <div className="flex-1 min-w-0">
                <div className="[font-family:'Inter',Helvetica] font-semibold text-[#d4e9f3] text-sm leading-snug">
          ...
          <div>
            <div className="flex items-center gap-2 mb-2.5 px-1">
              <div className="h-px flex-1 bg-[#ffffff0a]" />
              <span className="[font-family:'Inter',Helvetica] text-[#d4e9f330] text-[10px] uppercase tracking-widest">Other options</span>
              <div className="h-px flex-1 bg-[#ffffff0a]" />
            </div>
            <div className="grid grid-cols-2 gap-2">
              {[
                { id: "email",    label: "Email",    color: "#83eef0", icon: (
                ...
                { id: "twitter",  label: "Twitter/X", color: "#d4e9f3", icon: (
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.743l7.73-8.835L1.254 2.25H8.08l4.253 5.622 5.912-5.622zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
                )},
                ...
                { id: "sms",      label: "SMS / Phone", color: "#83eef0", icon: (
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none"><path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.79 10.6a19.79 19.79 0 01-3.07-8.67A2 2 0 012.7 0h3a2 2 0 012 1.72c.127.96.361 1.903.7 2.81a2 2 0 01-.45 2.11L6.91 7.61a16 16 0 006.29 6.29l.97-1.04a2 2 0 012.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0122 16.92z" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/></svg>
                )},
              ].map((opt) => (
                <button
                  key={opt.id}
                  ...
                  className="flex items-center gap-2.5 px-3 py-2.5 rounded-xl border border-[#ffffff0a] bg-[#ffffff04] hover:bg-[#ffffff0a] active:bg-[#ffffff10] transition-colors"
                >
